...
@InputType()
class WishlistCreateNestedManyWithoutUserProfilesInput {
...
export { WishlistCreateNestedManyWithoutUserProfilesInput as WishlistCreateNestedManyWithoutUserProfilesInput };
